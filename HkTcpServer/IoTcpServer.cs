...
namespace IoNetWork
{
    public class CustomExtra<T>
    {
        ...
        {
            return Dict.TryRemove(Key, out T Value);
        }
    }
    ...
    public class TcpServer :  ConnectionExtra, IServer
    {
        ...
        protected virtual bool CreateListener()
        {
            ...
            pListener = NetWorkLib.Create_HP_TcpServerListener();
            if (pListener == IntPtr.Zero)
            {
                return false;
            }
            pServer = NetWorkLib.Create_HP_TcpServer(pListener);
        ...
        public virtual void Destroy()
        {
            ...
            if (pServer != IntPtr.Zero)
            {
                NetWorkLib.Destroy_HP_TcpServer(pServer);
                pServer = IntPtr.Zero;
            }
            if (pListener != IntPtr.Zero)
            {
                NetWorkLib.Destroy_HP_TcpServerListener(pListener);
        ...
        public bool Start()
        {
            ...
            return NetWorkLib.HP_Server_Start(pServer, IpAddress, Port);
        }
        ...
        public bool Stop()
        {
            ...
            return NetWorkLib.HP_Server_Stop(pServer);
        }
        ...
        {
            return NetWorkLib.HP_Server_Send(pServer, connId, bytes, size);
        }
        ...
        {
            return NetWorkLib.HP_Server_Send(pServer, connId, bufferPtr, size);
        }
        ...
        {
            return NetWorkLib.HP_Server_SendPart(pServer, connId, bytes, size, offset);
        }
        ...
        {
            return NetWorkLib.HP_Server_SendPart(pServer, connId, bufferPtr, size, offset);
        }
        ...
        {
            return NetWorkLib.HP_Server_SendPackets(pServer, connId, pBuffers, count);
        }
        ...
        {
            return NetWorkLib.HP_TcpServer_SendSmallFile(pServer, connId, filePath, ref head, ref tail);
        }
        ...
        {
            return NetWorkLib.HP_Server_Disconnect(pServer, connId, force);
        }
        ...
        {
            return NetWorkLib.HP_Server_DisconnectLongConnections(pServer, period, force);
        }
        ...
        {
            return NetWorkLib.HP_Server_PauseReceive(pServer, connId, true);
        }
        ...
        {
            return NetWorkLib.HP_Server_PauseReceive(pServer, connId, false);
        }
        ...
        public ReceiveState GetReceiveState(IntPtr connId)
        {
            ...
            if (NetWorkLib.HP_Server_IsPauseReceive(pServer, connId, ref state))
            {
        ...
        {
            return NetWorkLib.HP_Server_DisconnectSilenceConnections(pServer, period, force);
        }
        ...
        public bool GetLocalAddress(IntPtr connId, ref string ip, ref ushort port)
        {
            ...
            bool ret = NetWorkLib.HP_Server_GetLocalAddress(pServer, connId, sb, ref ipLength, ref port) && ipLength > 0;
            if (ret == true)
            {
                ip = sb.ToString();
            }
        ...
        public bool GetRemoteAddress(IntPtr connId, ref string ip, ref ushort port)
        {
            ...
            bool ret = NetWorkLib.HP_Server_GetRemoteAddress(pServer, connId, sb, ref ipLength, ref port) && ipLength > 0;
            if (ret == true)
            {
                ip = sb.ToString();
            }
        ...
        {
            return NetWorkLib.HP_Server_GetPendingDataLength(pServer, connId, ref length);
        }
        ...
        public bool IsStarted
        {
            get
            {
                ...
                return NetWorkLib.HP_Server_HasStarted(pServer);
            }
        }
        ...
        public ServiceState State
        {
            get
            {
                return NetWorkLib.HP_Server_GetState(pServer);
            }
        ...
        public uint ConnectionCount
        {
            get
            {
                return NetWorkLib.HP_Server_GetConnectionCount(pServer);
            }
        ...
        public bool IsSecure
        {
            get
            {
                return NetWorkLib.HP_Server_IsSecure(pServer);
            }
        }
        ...
        public IntPtr[] GetAllConnectionIDs()
        {
            ...
            do
            {
                ...
                if (NetWorkLib.HP_Server_GetAllConnectionIDs(pServer, arr, ref count))
                {
                    if (arr.Length > count)
                    {
        ...
        public bool GetListenAddress(ref string ip, ref ushort port)
        {
            ...
            bool ret = NetWorkLib.HP_Server_GetListenAddress(pServer, sb, ref ipLength, ref port);
            if (ret == true)
            {
                ip = sb.ToString();
            }
        ...
        {
            return NetWorkLib.HP_Server_GetConnectPeriod(pServer, connId, ref period);
        }
        ...
        {
            return NetWorkLib.HP_Server_GetSilencePeriod(pServer, connId, ref period);
        }
        ...
        public uint MaxConnectionCount
        {
            get
            {
                return NetWorkLib.HP_Server_GetMaxConnectionCount(pServer);
            }
            set
            {
                NetWorkLib.HP_Server_SetMaxConnectionCount(pServer, value);
            }
        }
        ...
        public uint WorkerThreadCount
        {
            get
            {
                return NetWorkLib.HP_Server_GetWorkerThreadCount(pServer);
            }
            set
            {
                NetWorkLib.HP_Server_SetWorkerThreadCount(pServer, value);
            }
        }
        ...
        public uint AcceptSocketCount
        {
            get
            {
                return NetWorkLib.HP_TcpServer_GetAcceptSocketCount(pServer);
            }
            set
            {
                NetWorkLib.HP_TcpServer_SetAcceptSocketCount(pServer, value);
            }
        }
        ...
        public uint SocketBufferSize
        {
            get
            {
                return NetWorkLib.HP_TcpServer_GetSocketBufferSize(pServer);
            }
            set
            {
                NetWorkLib.HP_TcpServer_SetSocketBufferSize(pServer, value);
            }
        }
        ...
        public uint SocketListenQueue
        {
            get
            {
                return NetWorkLib.HP_TcpServer_GetSocketListenQueue(pServer);
            }
            set
            {
                NetWorkLib.HP_TcpServer_SetSocketListenQueue(pServer, value);
            }
        }
        ...
        public uint FreeSocketObjLockTime
        {
            get
            {
                return NetWorkLib.HP_Server_GetFreeSocketObjLockTime(pServer);
            }
            set
            {
                NetWorkLib.HP_Server_SetFreeSocketObjLockTime(pServer, value);
            }
        }
        ...
        public uint FreeSocketObjPool
        {
            get
            {
                return NetWorkLib.HP_Server_GetFreeSocketObjPool(pServer);
            }
            set
            {
                NetWorkLib.HP_Server_SetFreeSocketObjPool(pServer, value);
            }
        }
        ...
        public uint FreeBufferObjPool
        {
            get
            {
                return NetWorkLib.HP_Server_GetFreeBufferObjPool(pServer);
            }
            set
            {
                NetWorkLib.HP_Server_SetFreeBufferObjPool(pServer, value);
            }
        }
        ...
        public uint FreeSocketObjHold
        {
            get
            {
                return NetWorkLib.HP_Server_GetFreeSocketObjHold(pServer);
            }
            set
            {
                NetWorkLib.HP_Server_SetFreeSocketObjHold(pServer, value);
            }
        }
        ...
        public uint FreeBufferObjHold
        {
            get
            {
                return NetWorkLib.HP_Server_GetFreeBufferObjHold(pServer);
            }
            set
            {
                NetWorkLib.HP_Server_SetFreeBufferObjHold(pServer, value);
            }
        }
        ...
        public uint KeepAliveTime
        {
            get
            {
                return NetWorkLib.HP_TcpServer_GetKeepAliveTime(pServer);
            }
            set
            {
                NetWorkLib.HP_TcpServer_SetKeepAliveTime(pServer, value);
            }
        }
        ...
        public uint KeepAliveInterval
        {
            get
            {
                return NetWorkLib.HP_TcpServer_GetKeepAliveInterval(pServer);
            }
            set
            {
                NetWorkLib.HP_TcpServer_SetKeepAliveInterval(pServer, value);
            }
        }
        ...
        public bool MarkSilence
        {
            get
            {
                return NetWorkLib.HP_Server_IsMarkSilence(pServer);
            }
            set
            {
                NetWorkLib.HP_Server_SetMarkSilence(pServer, value);
            }
        }
        ...
        public SendPolicy SendPolicy
        {
            get
            {
                return NetWorkLib.HP_Server_GetSendPolicy(pServer);
            }
            set
            {
                NetWorkLib.HP_Server_SetSendPolicy(pServer, value);
            }
        }
        ...
        public OnSendSyncPolicy OnSendSyncPolicy
        {
            get
            {
                return NetWorkLib.HP_Server_GetOnSendSyncPolicy(pServer);
            }
            set
            {
                NetWorkLib.HP_Server_SetOnSendSyncPolicy(pServer, value);
            }
        }
        ...
        {
            return NetWorkLib.SYS_GetLastError();
        }
        ...
        {
            return NetWorkLib.SYS_WSAGetLastError();
        }
        ...
        public SocketError ErrorCode
        {
            get
            {
                return NetWorkLib.HP_Server_GetLastError(pServer);
            }
        }
        ...
        public string Version
        {
            get
            {
                return NetWorkLib.GetHPSocketVersion();
            }
        }
        ...
        public string ErrorMessage
        {
            get
            {
                IntPtr ptr = NetWorkLib.HP_Server_GetLastErrorDesc(pServer);
        ...
        ///////////////////////////////////////////////////////////////////////////////////////
        protected NetWorkLib.OnPrepareListen _OnPrepareListen = null;
        protected NetWorkLib.OnAccept _OnAccept = null;
        protected NetWorkLib.OnReceive _OnReceive = null;
        protected NetWorkLib.OnSend _OnSend = null;
        protected NetWorkLib.OnClose _OnClose = null;
        protected NetWorkLib.OnShutdown _OnShutdown = null;
        protected NetWorkLib.OnHandShake _OnHandShake = null;

        protected virtual void SetCallback()
        {
            _OnPrepareListen = new NetWorkLib.OnPrepareListen(SDK_OnPrepareListen);
            _OnAccept = new NetWorkLib.OnAccept(SDK_OnAccept);
            _OnSend = new NetWorkLib.OnSend(SDK_OnSend);
            _OnReceive = new NetWorkLib.OnReceive(SDK_OnReceive);
            _OnClose = new NetWorkLib.OnClose(SDK_OnClose);
            _OnShutdown = new NetWorkLib.OnShutdown(SDK_OnShutdown);
            _OnHandShake = new NetWorkLib.OnHandShake(SDK_OnHandShake);

            NetWorkLib.HP_Set_FN_Server_OnPrepareListen(pListener, _OnPrepareListen);
            NetWorkLib.HP_Set_FN_Server_OnAccept(pListener, _OnAccept);
            NetWorkLib.HP_Set_FN_Server_OnSend(pListener, _OnSend);
            NetWorkLib.HP_Set_FN_Server_OnReceive(pListener, _OnReceive);
            NetWorkLib.HP_Set_FN_Server_OnClose(pListener, _OnClose);
            NetWorkLib.HP_Set_FN_Server_OnShutdown(pListener, _OnShutdown);
            NetWorkLib.HP_Set_FN_Server_OnHandShake(pListener, _OnHandShake);
        }
        ...
        {
            IntPtr ptr = NetWorkLib.HP_GetSocketErrorDesc(code);
            string desc = Marshal.PtrToStringAnsi(ptr);
            return desc;
        }
        ...
        {
            return NetWorkLib.SYS_SetSocketOption(sock, level, name, val, len);
        }
        ...
        {
            return NetWorkLib.SYS_GetSocketOption(sock, level, name, val, ref len);
        }
        /// <summary>
        /// 调用系统的 ioctlsocket()
        /// </summary>
        ...
        {
            return NetWorkLib.SYS_IoctlSocket(sock, cmd, arg);
        }
        ...
        {
            return NetWorkLib.SYS_WSAIoctl(sock, dwIoControlCode, lpvInBuffer, cbInBuffer,
        ...
        /// 获取客户端网络地址和端口
        /// </summary>
        public string GetIpAndPortString(IntPtr ConnectId)
        {
            string Ip = string.Empty;
            ushort Port = 0;
            if (!GetRemoteAddress(ConnectId, ref Ip, ref Port))
                return string.Empty;

            var IpAndPort = Ip + ":" + Port.ToString();
            return IpAndPort;
        }
        ...
        /// 获取客户端网络地址
        /// </summary>
        public string GetIpString(IntPtr ConnectId)
        {
            string Ip = string.Empty;
            ushort Port = 0;
            if (!GetRemoteAddress(ConnectId, ref Ip, ref Port))
        ...
        /// 获取客户端网络端口
        /// </summary>
        public string GetPortString(IntPtr ConnectId)
        {
            //获取客户端地址和端口
            string Ip = string.Empty;
            ushort Port = 0;
